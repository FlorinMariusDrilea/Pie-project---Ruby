...
get '/order_manager_shef' do
    ...
    if nxt == "Next"
        ...
        @tweets.each do |tweet| 
              if tweet.user.screen_name == @database.get_first_value(query,[tweet.user.screen_name]) && @database.get_first_value(query_postcode,[tweet.user.screen_name]).upcase.start_with?('S')
    ...
    @orders = @pie_db.execute 'SELECT * FROM orders WHERE location = "sheffield"'
