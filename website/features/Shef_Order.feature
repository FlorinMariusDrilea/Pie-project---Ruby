Feature: sheffield order page

Scenario: Logging in 
    Given I am on the login page
    When I fill in "twitter_handle" with "shef_order_admin" within "#login"
    When I fill in "password" with "Orderadmin1" within "#login"
    When I press "submit" within "#login"
    Then I am on the sheffield order manager page
 ...
 Scenario: Showing all tweets
    ...
    Then I should be on the sheffield order manager page
